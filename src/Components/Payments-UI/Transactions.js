...
import { getAllPayments, getAllPaymentsAxiosVersion, getAllPaymentsRestVersion } from "./Datafunctions";
...
const Transactions = (props) => {
    ...
    const getTransactionsDataFromServer = () => {
        ...
        if (transactionsInRedux.length > 0  && timedifference < 60000) {
            ...
            const paymentsPromise = getAllPaymentsAxiosVersion(user.username, user.password);
    ...
    return <Fragment>
        ...
        <table id="transactionsTable" style= {{background: "#ccc"}} className="transactionsTable">
            <thead>
            <tr><th>Id</th><th>Order Id</th><th>Date</th><th>Country</th><th>Currency</th><th>amount</th><th></th></tr>
            </thead>
            <tbody>
            {displayTransactions}
            </tbody>
